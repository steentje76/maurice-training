...
- **F11 — Gym/Club/Team Platform: CURRENT (expliciet vrijgegeven door de Product Owner, 30 augustus 2026).** MS-F11-01: **CLOSED** — schrijffundament, drie kritieke security-bugs gevonden en gerepareerd. MS-F11-02: **CLOSED** — hergebruikt volledig F10 Coach Programming en de bestaande equipment-tabellen, twee genuine pre-existing bevindingen en twee eigen implementatiefouten gecorrigeerd. MS-F11-03 (Teams, Groups & Analytics): **CLOSED** — team-events/aanwezigheid/verantwoordelijkheden retroactief vastgelegd (schema-drift, 0 productie-impact, zie `docs/F11_MS_F11_03_REPORT.md`) en volledig adversarial bewezen. Server-side privacy-safe team-analytics-RPC gebouwd; **een kritieke, binnen dezelfde sessie zelf-geïntroduceerde en zelf-gerepareerde privacybug**: de minimum-cohort-drempel was aanvankelijk door de aanroeper zelf verlaagbaar (tot een enkele persoon herleidbaar), nu een server-side, niet-client-verlaagbare ondergrens. **Vier tenant-escape/data-integriteitsbugs** in team_events/attendance/responsibilities gevonden en gerepareerd (cross-tenant locatie-koppeling, team_id-mutatie, linked_training_instance zonder lidmaatschap, event_id/user_id-mutatie). Teamchat bewust **DEFERRED** (F9 bouwde ook geen messaging-engine); toekomstige notificaties zullen de bestaande `social_notifications` hergebruiken. Eén open productpunt (zie sectie 6) en één niet-blokkerende P2-observatie (GAP-P2-024). **F11 open P1: 0.** Volledige rapporten: `docs/F11_MS_F11_01_REPORT.md`, `docs/F11_MS_F11_02_REPORT.md`, `docs/F11_MS_F11_03_REPORT.md`. Resterende F11-mastersprints (MS-F11-04, MS-F11-05) nog niet uitgevoerd.
