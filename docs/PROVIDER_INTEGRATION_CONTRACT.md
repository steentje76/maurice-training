...
| Weather | Nog geen provider gekoppeld | N.v.t. | N.v.t. | N.v.t. | N.v.t. | N.v.t. | N.v.t. | NEE -- architectuur/adaptercontract bestaat, geen live provider-fetch, niet in runtime gekoppeld |
