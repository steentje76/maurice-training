...
| WEATHER-CONTEXT-001 | VALIDATED | NO ACTION | — (F5, MS-F5-06 CLOSED) |
| RUNNING-INTELLIGENCE-001 | IMPLEMENTED | INTEGRATION PENDING | — (F6, MS-F6-01 CLOSED, wiring-beperking GAP-P2-021) |
| CYCLING-INTELLIGENCE-001 | IMPLEMENTED | INTEGRATION PENDING | — (F6, MS-F6-02 CLOSED, zelfde wiring-beperking als GAP-P2-021) |
| SWIMMING-FEASIBILITY-001 | TESTED | NO ACTION | — (F6, MS-F6-06 CLOSED, feasibility PARTIAL - PROVIDER DEPENDENCIES OPEN) |
| LONGITUDINAL-TREND-001 | IMPLEMENTED | INTEGRATION PENDING | — (F7, MS-F7-01 CLOSED, nog niet geconsumeerd door dashboard) |
| PLATEAU-DETECTION-001 | IMPLEMENTED | INTEGRATION PENDING | — (F7, MS-F7-02 CLOSED, nog niet geconsumeerd door dashboard) |
| ADHERENCE-INTELLIGENCE-001 | IMPLEMENTED | INTEGRATION PENDING | — (F7, MS-F7-03 CLOSED, nog niet geconsumeerd door dashboard) |
...
| COACH-PROGRAM-ASSIGNMENT-001 | TESTED | NO ACTION | — (F10, MS-F10-03 CLOSED, GAP-P2-023 volledig gesloten, atomiciteit/idempotentie/revoke/delete-completeness bewezen) |
| COACH-INTELLIGENCE-001 | TESTED | NO ACTION | — (F10, MS-F10-04 CLOSED, Womens Performance-isolatie bewezen, geen shadow-calculation) |
| ORGANIZATION-CORE-001 | TESTED | NO ACTION | — (F11, MS-F11-01 CLOSED, twee tenant-escape-bugs live gevonden en gerepareerd) |
| GYM-PROGRAMMING-EQUIPMENT-001 | TESTED | NO ACTION | — (F11, MS-F11-02 CLOSED, hergebruikt volledig F10/equipment, geen tweede model) |
| TEAMS-GROUPS-ANALYTICS-001 | TESTED | NO ACTION | — (F11, MS-F11-03 CLOSED, kritieke privacy-bug zelf gevonden en gerepareerd) |
| GYM-DEVICE-FEASIBILITY-001 | TESTED | NO ACTION | — (F11, MS-F11-04 CLOSED, feasibility-only, external vendor validation open) |
| DYNAMIC-BRANDING-ADMIN-001 | TESTED | NO ACTION | — (F11, MS-F11-05 CLOSED, kritieke kolomlek gevonden en gerepareerd, runtime volledig geintegreerd) |
...
| END-CYCINTEL-001 | TESTED | CLOSED | -- (B9-05 CLOSED, snelheids-/vermogenstrend/consistency/CP bewezen, power zones/canonieke FTP bewust niet gebouwd) |
| END-CYCLINGCORE-001 | TESTED | CLOSED | -- (B9-04 CLOSED, gedeelde EnduranceExecutionCore, 0 Running-regressie, FTP/power-zones bewust minimaal) |
...
**Dekking: 71/71 capabilities geclassificeerd, 0 orphan** (Registry Coverage = 100%, zie hierboven).
