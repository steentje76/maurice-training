...
const CACHE_NAME = 'trainingskompas-v470010';
const CACHE_STATIC = 'trainingskompas-static-v470010';
...
const STATIC_ASSETS = [
  ...
  '/core/cardio.js',
  '/core/progression.js',
  '/core/trainingLoad.js',
  '/core/ergAnalyticsProjection.js',
  '/core/ergProtocolIdentity.js',
  '/core/inactivityAdherence.js',
  '/core/coaching.js',
  ...
  '/core/organizationCore.js',
  '/core/brandingCore.js',
  '/core/organizationContextRuntime.js',
  '/core/entitlementCore.js',
  '/core/commercialUxCore.js',
  '/manifest.json',
  '/icon-192.png',
  '/icon-512.png',
  '/logo-wordmark.png',
...
const NO_CACHE_PATTERNS = [
  ...
  'googleapis.com/v1',
  'open-meteo.com',
  '/.netlify/functions/'   // private provider-boundary (OAuth/sync) — NOOIT statisch cachen
];
